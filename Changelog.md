...
### Version 2019-06-13
* Update to [TerriaJS 7.6.0](https://github.com/TerriaJS/terriajs/blob/7.6.0/CHANGES.md).
...
* Removed the group "Topography -> Water -> Floods" as the services are no longer available.
...
* Added an autogenerated group of boundary layers to "Boundaries -> Boundaries used and hosted by ABS" from the Australian Bureau of Statistics.
* Removing the "Topography -> Land -> Geology" group of layer as these no longer work.
...
* Updated the Queensland Bioenergy layers in "Renewable Energy -> Bioenergy -> Queensland" and "Renewable Energy -> Bioenergy -> National -> Sugarcane".
