  ...
  const query = encodeURIComponent(`
      SELECT
        ...
        CASE
          ...
          WHEN CARDINAL_DIRECTION_SEQ='9' THEN 'NORTH TO SOUTH'
          WHEN CARDINAL_DIRECTION_SEQ='10' THEN 'EAST TO WEST'
      ...
      GROUP BY REF.STATION_ID,NAME,LGA,SUBURB,WGS84_LATITUDE,WGS84_LONGITUDE,YEAR,ROAD_FUNCTIONAL_HIERARCHY,CARDINAL_DIRECTION_SEQ
  `);
