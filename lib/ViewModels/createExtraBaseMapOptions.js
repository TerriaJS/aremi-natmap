...
var createExtraBaseMapOptions = function(terria) {
    ...
    voyager.attribution = '© OpenStreetMap contributors ODbL, © CartoDB CC-BY 3.0';

    voyager.opacity = 1.0;
    voyager.subdomains=['cartodb-basemaps-a','cartodb-basemaps-b','cartodb-basemaps-c','cartodb-basemaps-d'];
